...
class GCodeMove:
    def __init__(self, config):
        ...
        gcode.register_command('SAVE_ZOFFSET_TO_VARIABLE',
                               self.cmd_SAVE_ZOFFSET_TO_VARIABLE)
        gcode.register_command('LOAD_ZOFFSET_FROM_VARIABLE',
    ...
    def cmd_SAVE_ZOFFSET_TO_VARIABLE(self, gcmd):
        ...
        variables.save_variable('Variables', 'z_offset',
    ...
    def cmd_LOAD_ZOFFSET_FROM_VARIABLE(self, gcmd):
        ...
        gcode_move = self.printer.lookup_object("gcode_move")
        gcode_move.homing_position[2] = \
                float(variables.load_variable('Variables', 'z_offset'))
